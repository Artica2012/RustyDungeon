...
impl Plugin for AssetPlugin{
    fn build(&self, app: &mut App) {
        app.init_resource::<AssetList>()
            .add_systems(Startup, check_asset_loading.in_set(MainState::LoadAssets)); //This is updated after the old one was depreciated in .11: https://bevyengine.org/learn/migration-guides/0-10-to-0-11/
    }
}
